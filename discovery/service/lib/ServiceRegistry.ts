...
class ServiceRegistry {
  ...
  private generateKey(name: string, version: string, ip: string, port: string): string {
    return `${name}${version}${ip}${port}`;
  }

  private createService(name: string, version: string, ip: string, port: string): Service {
    return {
